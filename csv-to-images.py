...
csv_File_Path ='A_Z Handwritten Data.csv' #Your downloded csv file path

count = 1
last_digit_Name =  None

image_Folder_Path ='img' #your path to target folder to save images. Note: Path should have 26 empty folder with name as alphabets
